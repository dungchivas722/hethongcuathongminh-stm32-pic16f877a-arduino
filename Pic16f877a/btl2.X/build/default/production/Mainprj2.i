...
void main(void) {
    ...
    int joy_X = (ADC_Read(0));

    int joy_Y = (ADC_Read(1));


    {
    if ((joy_X < 200) && (joy_Y < 200) )
    ...
    { phai++;xuong=0;len=0;trai=0;}
     ...
     if((joy_X > 800) && (joy_Y <= 800) && (joy_Y >= 200) )
    ...
    if (phai >0 && tinhnang == 3 && trangthaim1==0) {trangthaim1=1;phai=0;_delay((unsigned long)((1000)*(20000000/4000.0))); UART_Write('x');
         _delay((unsigned long)((100)*(20000000/4000.0)));}
    if (phai >0 && tinhnang == 3 && trangthaim1==1) {trangthaim1=0;phai=0;_delay((unsigned long)((1000)*(20000000/4000.0)));UART_Write('z');
         _delay((unsigned long)((100)*(20000000/4000.0)));}
        if (phai >0 && tinhnang == 4 && trangthaim2==0) {trangthaim2=1;phai=0;_delay((unsigned long)((1000)*(20000000/4000.0)));UART_Write('c');
         _delay((unsigned long)((100)*(20000000/4000.0)));}
    if (phai >0 && tinhnang == 4 && trangthaim2==1) {trangthaim2=0;phai=0;_delay((unsigned long)((1000)*(20000000/4000.0)));UART_Write('v');
         _delay((unsigned long)((100)*(20000000/4000.0)));}
        if (phai >0 && tinhnang == 5 && trangthaim3==0) {trangthaim3=1;phai=0;_delay((unsigned long)((1000)*(20000000/4000.0)));UART_Write('b');
         _delay((unsigned long)((100)*(20000000/4000.0)));}
    if (phai >0 && tinhnang == 5 && trangthaim3==1) {trangthaim3=0;phai=0;_delay((unsigned long)((1000)*(20000000/4000.0)));UART_Write('n');
         _delay((unsigned long)((100)*(20000000/4000.0)));}
    ...
    if (phai>0 && tinhnang==7) {
        ...
        if (phai >0 && tinhnang == 8 && trangthaim4==0) {trangthaim4=1;phai=0;_delay((unsigned long)((1000)*(20000000/4000.0)));
        for (int i=1;i<5;i++)
        {UART_Write('p');
         _delay((unsigned long)((100)*(20000000/4000.0)));}}
    if (phai >0 && tinhnang == 8 && trangthaim4==1) {trangthaim4=0;phai=0;_delay((unsigned long)((1000)*(20000000/4000.0))); }
